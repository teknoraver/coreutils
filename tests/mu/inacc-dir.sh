#!/bin/sh
# Ensure that mu counts the size of an inaccessible directory.
...
mu -s a > out 2> /dev/null && fail=1

# mu won't be able to get cache stat if no permission
